...
\addcontentsline{toc}{chapter}{Two novel algorithms for dynamic kidney exchange}
\begin{center}
\large
\textsc{Vitor Hadad}
\end{center}
...
\paragraph{Improving the MAB algorithm}
...
% A principled way of going about this extension would be to 
% 
% 
% 
% \begin{algorithm}[htbp]
...
%   }
% 
%   \SetKwFunction{FChoose}{\texttt{extended\_mab}}
%   \SetKwProg{Fn}{Function}{:}{}
% 
%   \Fn{\FChoose{\textsc{Env},\ \texttt{h}, \ $thres$ }}{
%     \tcp{Begin iterations} \\
%     \For{$i\gets0$ \KwTo $L$}{
%       \tcp{} \\
%       $S_{t} = \arg\max_{C \subset \mathcal{C}} \sum_{c} {w_c}$
%       \tcp{a} \\
%       $b$
%     }
%   }
%  \caption{Function \texttt{extended\_mab}}
%  \label{alg:extended_mab}
% \end{algorithm} 
